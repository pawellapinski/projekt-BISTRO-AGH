...
function send_mail($config)
{
  ...
  $mail->Username = '45e732c8c7fd8a';                 // SMTP username
  $mail->Password = '2ab3ec5ea6269b';                           // SMTP password
  $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
  $mail->Port = 25;                                    // TCP port to connect to

  $mail->setFrom('poczta@pawel.pl', 'Nox');
  $mail->addAddress('poczta@pawel.pl', 'Nox');     // Add a recipient
...
<section class="parallax parallax-2">
    ...
    <!-- PHP Mailer wysyłanie wiadomości -->
    ...
    <div class="col-sm-7 slideanim">
      <div class="row">
        ...
        <div class="col-sm-12 form-group">
          <input class="form-control" name="mail_subject" placeholder="Temat wiadomości:"  required>
        </div>
      </div>
